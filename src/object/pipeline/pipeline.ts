 ...
 */
import * as UserInput from '@/object/pipeline/user-input';
import * as Metadata from '@/object/pipeline/metadata';
import * as Normalize from '@/object/pipeline/normalize';
import * as CoverArtArchive from '@/object/pipeline/coverartarchive/coverartarchive';
